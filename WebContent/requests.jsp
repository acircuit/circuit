					...
					<c:if test="${user.getUserId() == request.getUserId()}">
						 <div class="row" style="background-color:#f8f8f8">
				            <div class="col-md-8">
				                ...
				                <c:url value="/AdvisorMyAccountRequestViewDetailsController" var="myURL">
				            ...
				            <c:if test="${request.getStatus().equals('PENDING FOR ADVISOR APPROVAL')  }">
					            <div class="col-md-4">
						                <h3>Time Left For Reply</h3>
