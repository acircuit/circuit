		...
		`<div id="PDF" style="margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
              <div class="panel panel-info">
                   ...
                   <div class="panel-body" >
                       <form id="forgot_password_form" class="form-horizontal" role="form" action="/Tomact_7/AdminAdvisorProfileEditController" method="post">
                           
                            <div class="panel-heading">
                         			<div class="panel-title" style="font-size:26px">Input Email To Edit Profile
                        			</div>
                				</div>
                					<hr>
