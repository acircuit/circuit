...
<html lang="en">
  <head>
	...
	<link href='http://fonts.googleapis.com/css?family=Lato:300,400,900' rel='stylesheet' type='text/css'>
    	<% List<SearchDTO> advisors= (List<SearchDTO>)request.getAttribute("searchedadvisor");
		List<SearchDTO> advisorskill= (List<SearchDTO>)request.getAttribute("searchedadvisorskill");
                                        ...
                                        <div class="col-lg-4">
					           			<a href="${myURL}">
											<table width="100%" cellpadding="0" cellspacing="0">
												<tr><td><img src="${advisor.getPicture()}" style="width:140px;height:141px" alt="">
